...
"if exists("syntax_on")
    "syntax reset
"endif
let g:colors_name="monokaipy"

let purple            = { "gui": "#5f5fff", "cterm": "63"}
let yellow            = { "gui": "#d7af00", "cterm": "178"}
let orange            = { "gui": "#af8700", "cterm": "208"}
let lightPurple       = { "gui": "#af5fff", "cterm": "135"}
let lightBlue         = { "gui": "#87d7ff", "cterm": "45"}
let pink              = { "gui": "#af5f5f", "cterm": "197"}
let darkRed           = { "gui": "#af00ff", "cterm": "129"}
let green             = { "gui": "#5faf5f", "cterm": "118"}

let seaGreen          = { "gui": "#00875f", "cterm": "29"}
let darkYellow        = { "gui": "#00afd7", "cterm": "38"}
let lightGreen        = { "gui": "#5f8787", "cterm": "66"}
let red               = { "gui": "#870000", "cterm": "1"}
let tan               = { "gui": "#87875f", "cterm": "11"}
let defaultBackground = { "gui": "#000000", "cterm": "0"}
let darkerGrey        = { "gui": "#000000", "cterm": "0"}
let darkGrey          = { "gui": "#303030", "cterm": "236"}
let grey              = { "gui": "#4e4e4e", "cterm": "239"}
let lightGrey         = { "gui": "#8a8a8a", "cterm": "246"}
let defaultForeground = { "gui": "#a8a8a8", "cterm": "252"}
